    ...
    <div className="container">
      ...
      <div className="text-[18px] items-center text-center font-[poppins]">
        ...
        <p className="font-[400] text-body">
          Explore expert advice, trending industry updates, how-to guides, and
          stories from real customers—all designed to help you make better
          service decisions across home, event, repair, and rental needs.
        </p>
      </div>
                ...
                <div className=" ">
                  <div className=" w-full relative h-[250px] xs:h-[280px] rounded-[30px]">
                    <Image
                      width={350}
                      height={300}
                      className="w-full h-[250px] xs:h-[280px] object-fit rounded-[30px]"
                      src={itm.image}
                      alt="blog-image"
                    />
                    <Image
                      src="/assets/images/mask.png"
                      className="absolute top-0 h-[250px] xs:h-[280px]"
                      width={350}
                      height={300}
                    />
