...
export const javascriptChallenges: Challenge[] = [
  ...
  return function(b) {
    ...
    },
    {
        ...
        tests: [
            { input: [(x: number, y: number) => x + y], expected: "function" }
        ],
        difficulty: "Hard",
        topic: "Currying",
  ...
  return function curried(...args) {
    ...
    },
    {
        ...
        tests: [
            { input: [(x: number, y: number) => x + y, 5], expected: "function" }
        ],
        difficulty: "Medium",
        topic: "Currying",
  ...
  return function(domain) {
    ...
    // --- CALL / APPLY / BIND ---
    {
        ...
        tests: [
            { input: [function (this: { x: number }) { return this.x; }, { x: 42 }], expected: "function" }
        ],
        difficulty: "Hard",
  ...
  return function(...laterArgs) {
    ...
    },
    {
        ...
        tests: [
            { input: [function (this: { x: number }, a: number) { return this.x + a; }, { x: 10 }, 5], expected: 15 }
        ],
        difficulty: "Hard",
        topic: "Call/Apply/Bind",
  ...
  return result;
    ...
    },
    {
        ...
        tests: [
            { input: [function (this: { x: number }, a: number, b: number) { return this.x + a + b; }, { x: 10 }, [5, 5]], expected: 20 }
        ],
        difficulty: "Hard",
        topic: "Call/Apply/Bind",
