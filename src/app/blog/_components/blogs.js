...
export const blogs = [
    ...
    },
    {
      ...
      description: "Learn how ServiceConnekt builds intuitive, feature-rich mobile apps tailored for your business goals.",
      date: "August 5, 2025",
      cat:"Technology",
      author: "ServiceConnekt Team",
    ...
    },
    {
      ...
      description: "From tools to platforms, ServiceConnekt crafts software tailored to your business goals and workflows.",
      date: "August 7, 2025",
      author: "ServiceConnekt Team",
    ...
    },
    {
      ...
      description: "Learn how ServiceConnekt helps startups launch MVPs quickly to test, validate, and iterate with real users.",
      date: "August 10, 2025",
      author: "ServiceConnekt Team",
      cat:"Technology",
    ...
    },
    {
      ...
      description: "ServiceConnekt helps modernize outdated platforms with sleek UI, improved performance, and scalable architecture.",
      date: "August 12, 2025",
      author: "ServiceConnekt Team",
      cat:"Engineering",
      image: "/assets/images/blogs_updated/Banking_img.png",
    },
    {
      ...
      description: "Give your brand a powerful digital reboot with modern design, better UX, and mobile optimization through ServiceConnekt.",
      date: "August 14, 2025",
      author: "ServiceConnekt Team",
...
export const blogContent = [
    {
      ...
      content: [
        { type: "paragraph", text: "Your website is the digital front door to your brand. At ServiceConnekt, we go beyond just creating pretty pages—we build intuitive, high-performing websites that tell your story and make visitors stick around." },
        ...
        { type: "paragraph", text: "Whether you're launching a new venture or reimagining an existing brand, ServiceConnekt helps you create a digital presence that drives results." },
    ...
    },
    {
      ...
      content: [
        { type: "paragraph", text: "Mobile is where your users are. ServiceConnekt develops high-performing mobile apps for iOS and Android focusing on usability, speed, and reliability." },
        ...
        { type: "paragraph", text: "Whether it’s consumer apps, internal tools, or marketplaces, ServiceConnekt builds apps that perform." }
      ]
    },
    {
      id: 3,
      ...
      content: [
        { type: "paragraph", text: "Every business is unique. That’s why ServiceConnekt builds custom software solutions—scalable, secure, and aligned with your operational needs." },
    ...
    },
    {
      ...
      content: [
        { type: "paragraph", text: "Launching an MVP validates your idea without wasting time or budget. At ServiceConnekt, we build lean MVPs fast so you can gather feedback early." },
    ...
    },
    {
      ...
      content: [
        { type: "paragraph", text: "Old systems can hurt your productivity. ServiceConnekt modernizes legacy platforms—preserving what works and delivering a modern user experience." },
    ...
    },
    {
      ...
      content: [
        { type: "paragraph", text: "Your site deserves a glow-up. ServiceConnekt offers full website refresh and rebranding services to help your brand shine online." },
