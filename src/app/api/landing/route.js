    ...
    try {
      ...
      const transporter = nodemailer.createTransport({
        ...
        auth: {
          ...
          pass: "nfqg doum ajgn odkn",
        },
      });
   
      const infoEmailData = {
        to: "info@hexabells.com",
        cc : ["akanksha@hexabells.com","vishwa@hexabells.com"],
        from: "Hexabells <info@hexabells.com>",
        subject: "Lead From Landing Page",
        text: `Name: ${body.name}\nCompany: ${body.company_name}\nEmail: ${body.email}\nPhone: ${body.contact_number.slice(2)}`,
      };
                  ...
                  <tr>
                    <td style="background-color: #ffffff">
                      ...
                      <div>
                        ...
                        <h3>
                          Welcome to
                          <span style="color: #eb7373">HexaBells</span>
                        </h3>
                        <p>
                        ...
                        <a
                          ...
                          "
                          href="https://www.figma.com/proto/V4YsvaAh8UhyjnDu4IRaMq/Hexabells?page-id=0%3A1&type=design&node-id=2-38418&viewport=567%2C388%2C0.08&t=W0lf6WaQ40yRMcSF-1&scaling=scale-down-width"
                          target="_blank"
                        >
                          View Profile!
                        </a>
                        <p>
                          ...
                          <span style="color: #eb7373;text-decoration: none;">projects@hexabells.com</span>.
                        </p>
      
                        <p>
                          Thank you once again for considering Hexabells as your
                        ...
                        <span>Hexabells Technologies Pvt. Ltd.</span><br />
