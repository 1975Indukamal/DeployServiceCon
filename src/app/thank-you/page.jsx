               ...
               <div className='max-w-full'>
                <div className='p-0'>
                    ...
                    <div className='p-[15px]'>
                        <h1 className="text-[26px] sm:text-[36px] text-center font-medium text-body">Thank You for Choosing Us to Build Your <br /><span className="text-[35px] sm:text-[45px] text-primary">Digital Dreams!</span></h1>
                        {/* <h1><span>Thank You</span> for Choosing Us to Build Your Digital Dreams!</h1>  */}
                        <p className="text-[14px] text-center text-body">Our team of experts is gearing up to connect with you very soon. Get ready to dive into the world of possibilities!</p>
                    </div>
